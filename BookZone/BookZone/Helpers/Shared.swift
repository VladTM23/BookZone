...
//  BookZone
//
//  Created by Alexandra-Gabriela Laicu-Hausberger on 18.11.2020.
...
enum ActionDescriptor {
    ...
    func title(forDisplayMode displayMode: ButtonDisplayMode) -> String? {
        ...
        switch self {
        case .read: return "Unmark as read"
        case .unread: return "Mark as read"
    ...
    func image(forStyle style: ButtonStyle, displayMode: ButtonDisplayMode) -> UIImage? {
        ...
        if #available(iOS 13.0, *) {
            let name: String
            switch self {
            case .read: name = "bookmark"
            case .unread: name = "bookmark.fill"
    ...
    #else
        switch self {
        case .read, .unread: return #colorLiteral(red: 0.4666666687, green: 0.7647058964, blue: 0.2666666806, alpha: 1)
